...
import { el, fetchMarket, fmtPct, fmtPrice, fmtNum } from './api.js?v=0.75.11-heatmap-tf-recalibration-20260524';
import { ICN, statCard, card, pageHead, tag, barbar, heatColorClass, heatmapRow } from './components.js?v=0.75.11-heatmap-tf-recalibration-20260524';
import { upcomingMacroEvents, evaluateMacroEventRisk } from './rux_macro.js?v=0.75.11-heatmap-tf-recalibration-20260524';
import { fetchEconCalendar } from './api.js?v=0.75.11-heatmap-tf-recalibration-20260524';
