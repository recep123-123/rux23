...
import { el, fetchMarket, fmtPct, fmtPrice, fmtNum } from './api.js?v=0.75.2-funding-responsive-live-20260524';
import { ICN, statCard, card, pageHead, tag, barbar, heatColorClass, heatmapRow } from './components.js?v=0.75.2-funding-responsive-live-20260524';
import { upcomingMacroEvents, evaluateMacroEventRisk } from './rux_macro.js?v=0.75.2-funding-responsive-live-20260524';
import { fetchEconCalendar } from './api.js?v=0.75.2-funding-responsive-live-20260524';
