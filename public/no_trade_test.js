...
import { el, State, fetchMarket, fmtNum } from './api.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { ICN, card, pageHead, statCard, tag } from './components.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { makeDemoCandles, analyzeLiveMarketSignal, simulateManualPlanOutcome } from './rux_core.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
