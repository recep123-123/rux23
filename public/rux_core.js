...
export const RUX_VERSION = '0.75.15-heatmap-chart-fidelity-side-density-20260524';
...
export function analyzeLiveMarketSignal({ symbol = 'BTCUSDT', tf = '4h', marketData = null, previousRegime = null } = {}) {
  // KARAR YOLU SENTETİK VERİ YASAĞI (v0.75.15-heatmap-chart-fidelity-side-density-20260524 Hiçbir ekran demo/sentetik mumu
