...
import { State, fetchMarket, el, fmtPct, fmtPrice } from './api.js?v=0.75.7-liquidation-source-health-20260524';
import { ICN, statCard, card, pageHead, checklist, ringGauge, barbar } from './components.js?v=0.75.7-liquidation-source-health-20260524';
