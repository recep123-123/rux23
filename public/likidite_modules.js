...
import { el, fetchMarket, fmtPrice, fmtNum, atr, ema } from './api.js?v=0.75.2-funding-responsive-live-20260524';
import { ICN, statCard, card, pageHead, tag, barbar, heatColorClass } from './components.js?v=0.75.2-funding-responsive-live-20260524';
