...
import { buildRuxApiHeaders, getRuxSettings } from './rux_settings.js?v=0.75.7-liquidation-source-health-20260524';
...
async function fetchBinanceLiveBrowserFallback(symbol = 'BTCUSDT', tf = '4h', limit = 240, serverPayload = null) {
  ...
  return {
    ok,
    version: 'RUx v0.75.7-liquidation-source-health-20260524',
...
export async function fetchBinanceLive(symbol = 'BTCUSDT', tf = '4h', limit = 240) {
  ...
  try {
    ...
    browser.version = 'RUx v0.75.7-liquidation-source-health-20260524';
    return browser;
  } catch (e) {
    if (server) {
