...
import { fetchNews, State, el, fmtTimeShort, toast } from './api.js?v=0.75.4-cvd-headerfix-overflowfix-20260524';
import { ICN, statCard, pageHead } from './components.js?v=0.75.4-cvd-headerfix-overflowfix-20260524';
