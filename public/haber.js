...
import { fetchNews, State, el, fmtTimeShort, toast } from './api.js?v=0.75.11-heatmap-tf-recalibration-20260524';
import { ICN, statCard, pageHead } from './components.js?v=0.75.11-heatmap-tf-recalibration-20260524';
