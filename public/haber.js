...
import { fetchNews, State, el, fmtTimeShort, toast } from './api.js?v=0.75.7-liquidation-source-health-20260524';
import { ICN, statCard, pageHead } from './components.js?v=0.75.7-liquidation-source-health-20260524';
