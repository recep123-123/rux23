...
export async function renderMontecarlo(host) {
  ...
  host.appendChild(pageHead({
    ...
    subtitle: 'RUx v0.75.10-heatmap-fidelity-pass-20260524 aynı Net-R işlem dizisini 1000+ farklı sırayla karıştırır; drawdown dağılımı, ruin riski ve stability skorunu birlikte ölçer.',
    actions: [
  ...
  const loading = el('div', { class: 'card section' }, el('div', { class: 'card-title' }, 'RUx v0.75.10-heatmap-fidelity-pass-20260524 Monte Carlo motoru çalışıyor…'));
