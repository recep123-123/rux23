...
import { toast } from './api.js?v=0.75.6-liquidation-compact-trusted-20260524';
...
function markButtons(host){
  ...
  for (const btn of buttons){
    ...
    btn.title = btn.title || `RUx v0.75.6-liquidation-compact-trusted-20260524 generic bridge: ${kind}`;
  }
  return counts;
}
