...
import { toast } from './api.js?v=0.75.2-funding-responsive-live-20260524';
...
function markButtons(host){
  ...
  for (const btn of buttons){
    ...
    btn.title = btn.title || `RUx v0.75.2-funding-responsive-live-20260524 generic bridge: ${kind}`;
  }
  return counts;
}
