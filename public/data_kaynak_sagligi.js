...
import { el, fmtTime, getRuxSourceLog } from './api.js?v=0.75.10-heatmap-fidelity-pass-20260524';
import { runDataSourceHealthCheck, loadLastDataSourceHealthReport, clearDataSourceHealthLog, makeDataHealthExport } from './rux_data_health.js?v=0.75.10-heatmap-fidelity-pass-20260524';
import { storageStats, loadAudit, isPersistenceAvailable, clearAllStorage } from './rux_storage.js?v=0.75.10-heatmap-fidelity-pass-20260524';
...
export async function renderDataKaynakSagligi(host) {
  ...
  host.appendChild(el('div', { class:'page-head' },
    el('div', {},
      el('div', { class:'page-kicker' }, 'RUx v0.75.10-heatmap-fidelity-pass-20260524 — BINANCE LIVE DATA HEALTH'),
...
async function guardedRun(host, force) {
  ...
  try { return await runDataSourceHealthCheck({ force }); }
    ...
    const payload = {
      version: 'RUx v0.75.10-heatmap-fidelity-pass-20260524', checkedAt: new Date().toISOString(), durationMs: 0,
