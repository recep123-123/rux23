...
import { fetchIntel, el, testApiEndpoint, RUX_HEALTH_ENDPOINTS, getRuxSourceLog, clearRuxSourceLog } from './api.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { getRuxSettings, maskSecret, settingsCompletionScore, getOrderflowScoreMode, orderflowScoreModeLabel } from './rux_settings.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { ICN, statCard, card, pageHead } from './components.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { makeRuxSystemSnapshot, makeRuxDecisionSnapshot, statusClass, makeRuxDataConfidenceReport } from './rux_core.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { loadRecentErrors, loadAudit, storageStats, isPersistenceAvailable } from './rux_storage.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
...
export async function renderSistem(host) {
  ...
  [
    ...
    ['08:18','INFO','Sistem güncellemesi başarılı (RUx v0.75.15-heatmap-chart-fidelity-side-density-20260524','green'],
