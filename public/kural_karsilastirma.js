...
import { ICN, statCard, card, pageHead, tag, barbar } from './components.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { makeRuxBacktestSnapshot } from './rux_core.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
import { buildRuleComparisonReport, RULE_COMPARISON_CATEGORIES, ruleComparisonCategoryLabel } from './rux_rule_compare.js?v=0.75.15-heatmap-chart-fidelity-side-density-20260524';
