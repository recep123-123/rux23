...
import { el, fetchCVD, fetchLiquidity, fetchFutures } from './api.js?v=0.75.7-liquidation-source-health-20260524';
import { card, barbar, checklist, tag } from './components.js?v=0.75.7-liquidation-source-health-20260524';
