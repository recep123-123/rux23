...
import { State, fetchMarket, el } from './api.js?v=0.75.6-liquidation-compact-trusted-20260524';
import { ICN, statCard, card, pageHead, checklist, ringGauge } from './components.js?v=0.75.6-liquidation-compact-trusted-20260524';
