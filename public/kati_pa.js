...
import { State, fetchMarket, el } from './api.js?v=0.75.7-liquidation-source-health-20260524';
import { ICN, statCard, card, pageHead, checklist, ringGauge } from './components.js?v=0.75.7-liquidation-source-health-20260524';
