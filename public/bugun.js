...
import { State, el, fmtPct } from './api.js?v=0.75.6-liquidation-compact-trusted-20260524';
import { ICN, statCard, card, pageHead, ringGauge, coinPill, checklist, barbar } from './components.js?v=0.75.6-liquidation-compact-trusted-20260524';
