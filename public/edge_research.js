...
import { ICN, statCard, card, pageHead, tag, barbar, progress } from './components.js?v=0.75.8-heatmap-panel-live-20260524';
import { makeEdgeResearchDashboardReport } from './rux_edge_dashboard.js?v=0.75.8-heatmap-panel-live-20260524';
...
export async function renderEdgeResearch(host) {
  ...
  host.appendChild(pageHead({
    ...
    subtitle: 'RUx v0.75.8-heatmap-panel-live-20260524 setup matrisi, kural karşılaştırma, OOS, Monte Carlo, data health, Binance live wiring, replay ve user fidelity çıktılarını tek araştırma komuta panelinde birleştirir.',
    actions: [
